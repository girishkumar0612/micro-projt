...
import { Send, RotateCcw, Sparkles, BookOpen } from 'lucide-react';
import { useChatStore } from '@/store/chatStore';
import { useAutoScroll } from '@/hooks';
import { renderMarkdown, cn } from '@/utils';
...
export function ChatPage() {
  const { messages, isTyping, sendMessage, clearChat, retryLast } = useChatStore();
