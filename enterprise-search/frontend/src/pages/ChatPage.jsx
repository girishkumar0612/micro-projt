        ...
        <div className="flex-1 overflow-y-auto py-6 flex flex-col gap-5">
          {messages.length === 0 ? (
            ...
            >
              ...
              <h2 className="font-display text-lg font-semibold text-ink">Ask anything about your documents</h2>
              <p className="text-sm text-ink-soft mt-1.5 max-w-sm">
                Answers are generated only from what admins have uploaded and indexed.
              </p>
