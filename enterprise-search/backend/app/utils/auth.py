...
Roles: admin | hr | finance | it | marketing | operations
...
ALLOWED_ROLES = {"admin", "hr", "finance", "it", "marketing", "operations"}
...
def get_user_role(x_user_role: str | None = Header(default=None)) -> str:
    ...
    Allowed values: admin | hr | finance | it | marketing | operations
    """
